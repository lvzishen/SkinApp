...
public class ImpressionTracker {
    ...
    public ImpressionTracker(@NonNull final Context context) {
        this(new WeakHashMap<View, ImpressionInterface>(),
                new WeakHashMap<View, TimestampWrapper<ImpressionInterface>>(), new VisibilityTracker.VisibilityChecker(),
                new VisibilityTracker(context), new Handler(Looper.getMainLooper()));
    }

    public ImpressionTracker(@NonNull final View rootView) {
        this(new WeakHashMap<View, ImpressionInterface>(),
                new WeakHashMap<View, TimestampWrapper<ImpressionInterface>>(), new VisibilityTracker.VisibilityChecker(),
                new VisibilityTracker(rootView), new Handler(Looper.getMainLooper()));
    }
    ...
    ImpressionTracker(@NonNull final Map<View, ImpressionInterface> trackedViews,
                      ...
                      @NonNull final VisibilityTracker.VisibilityChecker visibilityChecker, @NonNull final VisibilityTracker visibilityTracker,
    ...
    class PollingRunnable implements Runnable {
        ...
        public void run() {
            for (final Map.Entry<View, TimestampWrapper<ImpressionInterface>> entry : mPollingViews.entrySet()) {
                ...
                if (!mVisibilityChecker.hasRequiredTimeElapsed(timestampWrapper.mCreatedTimestamp,
