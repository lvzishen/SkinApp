...
public class GooglePlayServicesAdapterConfiguration extends BaseAdapterConfiguration {
    ...
    private static final String MOPUB_NETWORK_NAME = ModuleConfig.ADMOB_NETWORK_NAME;
    ...
    public void initializeNetwork(@NonNull Context context, @Nullable Map<String, String>
        ...
        synchronized (com.mopub.mobileads.GooglePlayServicesAdapterConfiguration.class) {
            try {
        ...
        if (networkInitializationSucceeded) {
            listener.onNetworkInitializationFinished(com.mopub.mobileads.GooglePlayServicesAdapterConfiguration.class,
