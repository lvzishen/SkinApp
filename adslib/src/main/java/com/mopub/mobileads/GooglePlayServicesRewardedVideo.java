...
public class GooglePlayServicesRewardedVideo extends CustomEventRewardedVideo implements
     ...
     */
    private static final String ADAPTER_NAME = com.mopub.mobileads.GooglePlayServicesRewardedVideo.class.getSimpleName();
        ...
        if (!sIsInitialized.getAndSet(true)) {
            ...
            if (TextUtils.isEmpty(serverExtras.get(KEY_EXTRA_AD_UNIT_ID))) {
                ...
                MoPubRewardedVideoManager.onRewardedVideoLoadFailure(
                        com.mopub.mobileads.GooglePlayServicesRewardedVideo.class,
                        getAdNetworkId(),
                        MoPubErrorCode.NETWORK_NO_FILL);
                return false;
            }
            ...
            mRewardedVideoAd.setRewardedVideoAdListener(com.mopub.mobileads.GooglePlayServicesRewardedVideo.this);
        ...
        new Handler(Looper.getMainLooper()).post(new Runnable() {
            ...
            public void run() {
                ...
                if (TextUtils.isEmpty(serverExtras.get(KEY_EXTRA_AD_UNIT_ID))) {
                    ...
                    MoPubRewardedVideoManager.onRewardedVideoLoadFailure(
                            com.mopub.mobileads.GooglePlayServicesRewardedVideo.class,
                            com.mopub.mobileads.GooglePlayServicesRewardedVideo.class.getSimpleName(),
                ...
                if (mRewardedVideoAd.isLoaded()) {
                    MoPubRewardedVideoManager
                            .onRewardedVideoLoadSuccess(com.mopub.mobileads.GooglePlayServicesRewardedVideo.class, getAdNetworkId());
                } else {
