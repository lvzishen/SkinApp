...
public class FacebookRewardedVideo extends CustomEventRewardedVideo implements RewardedVideoAdListener {
    ...
    private static final String ADAPTER_NAME = com.mopub.mobileads.FacebookRewardedVideo.class.getSimpleName();
    ...
    public FacebookRewardedVideo() {
        ...
        mAdExpiration = new Runnable() {
            ...
            public void run() {
                ...
                MoPubRewardedVideoManager.onRewardedVideoLoadFailure(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId, EXPIRED);
    ...
    protected void loadWithSdkInitialized(@NonNull Activity activity, @NonNull Map<String, Object> localExtras, @NonNull Map<String, String> serverExtras) throws Exception {
        if (!serverExtras.isEmpty()) {
            ...
            if (!TextUtils.isEmpty(mPlacementId)) {
                ...
                MoPubRewardedVideoManager.onRewardedVideoLoadFailure(com.mopub.mobileads.FacebookRewardedVideo.class, getAdNetworkId(), MoPubErrorCode.NETWORK_NO_FILL);
        ...
        if (mRewardedVideoAd != null) {
            if (mRewardedVideoAd.isAdLoaded()) {
                MoPubRewardedVideoManager.onRewardedVideoLoadSuccess(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId);
    ...
    protected void showVideo() {
        ...
        if (mRewardedVideoAd != null && hasVideoAvailable()) {
            ...
            MoPubRewardedVideoManager.onRewardedVideoPlaybackError(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId, MoPubErrorCode.NETWORK_NO_FILL);
    ...
    public void onRewardedVideoCompleted() {
        MoPubRewardedVideoManager.onRewardedVideoCompleted(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId, MoPubReward.success(MoPubReward.NO_REWARD_LABEL, MoPubReward.DEFAULT_REWARD_AMOUNT));
    ...
    public void onLoggingImpression(Ad ad) {
        cancelExpirationTimer();
        MoPubRewardedVideoManager.onRewardedVideoStarted(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId);
        MoPubLog.log(SHOW_SUCCESS, ADAPTER_NAME);
    }

    @Override
    public void onRewardedVideoClosed() {
        MoPubRewardedVideoManager.onRewardedVideoClosed(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId);
    }
    ...
    public void onAdClicked(Ad ad) {
        MoPubRewardedVideoManager.onRewardedVideoClicked(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId);
    ...
    public void onError(Ad ad, AdError adError) {
        cancelExpirationTimer();
        MoPubRewardedVideoManager.onRewardedVideoLoadFailure(com.mopub.mobileads.FacebookRewardedVideo.class, mPlacementId, mapErrorCode(adError.getErrorCode()));
