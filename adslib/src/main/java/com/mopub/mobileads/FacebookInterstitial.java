...
public class FacebookInterstitial extends CustomEventInterstitial implements InterstitialAdListener {
    ...
    private static final String ADAPTER_NAME = com.mopub.mobileads.FacebookInterstitial.class.getSimpleName();
    ...
    public void onLoggingImpression(Ad ad) {
        ...
        CoversControl.getInstance().trigger(XalContext.getContext(),ad.getPlacementId());
    }
