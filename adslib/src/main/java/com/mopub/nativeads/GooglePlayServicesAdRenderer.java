...
/**
 * The {@link com.mopub.nativeads.GooglePlayServicesAdRenderer} class is used to render
...
public class GooglePlayServicesAdRenderer implements MoPubAdRenderer<GooglePlayServicesNative.GooglePlayServicesNativeAd> {
     ...
     */
    private static final String ADAPTER_NAME = com.mopub.nativeads.GooglePlayServicesAdRenderer.class.getSimpleName();
    ...
    public void renderAdView(@NonNull View view,
                             @NonNull GooglePlayServicesNative.GooglePlayServicesNativeAd nativeAd) {
    ...
    private void updateUnifiedAdview(GooglePlayServicesNative.GooglePlayServicesNativeAd staticNativeAd,
    ...
    public boolean supports(@NonNull BaseNativeAd nativeAd) {
        return nativeAd instanceof GooglePlayServicesNative.GooglePlayServicesNativeAd;
    }
