...
public class FacebookNative extends CustomEventNative {
    ...
    private static final String ADAPTER_NAME = com.mopub.nativeads.FacebookNative.class.getSimpleName();
    ...
    public static void registerChildViewsForInteraction(final View view, final NativeAd nativeAd,
                                                        final MediaView mediaView, final AdIconView adIconView) {
        registerChildViewsForInteraction(view, nativeAd, mediaView, adIconView, new ArrayList<View>());
    }

    public static void registerChildViewsForInteraction(final View view, final NativeAd nativeAd,
                                                        final MediaView mediaView, final AdIconView adIconView, List<View> clickableViews) {
    ...
    public static class FacebookVideoEnabledNativeAd extends BaseNativeAd implements NativeAdListener {
        ...
        public void registerChildViewsForInteraction(final View view, final MediaView mediaView,
                                                     final AdIconView adIconView) {
//            registerChildViewsForInteraction(view, mediaView, adIconView,new ArrayList<View>());
        }

        public void registerChildViewsForInteraction(final View view, final MediaView mediaView,
                                                     final AdIconView adIconView, List<View> clickableViews) {
            com.mopub.nativeads.FacebookNative.registerChildViewsForInteraction(view, mNativeAd, mediaView, adIconView, clickableViews);
