...
import com.goodmorning.view.recyclerview.interfaces.OnItemLongClickListener;
...
public class CommonRecyclerViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public CommonRecyclerViewAdapter(RecyclerView.Adapter innerAdapter) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        if (mRefreshHeader == null || mFooterViews == null){
