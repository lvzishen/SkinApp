package com.goodmorning.view.recyclerview;
...
public class CommonRecyclerView extends RecyclerView {
    ...
    private CommonRecyclerViewAdapter mWrapAdapter;
...
//            setLoadMoreFooter(new LoadingFooter(getContext().getApplicationContext()),false);
    ...
    public void setAdapter(Adapter adapter) {
        ...
        mWrapAdapter = (CommonRecyclerViewAdapter) adapter;
    ...
    private class DataObserver extends RecyclerView.AdapterDataObserver {
        ...
        public void onChanged() {
            ...
            if (adapter instanceof CommonRecyclerViewAdapter) {
                CommonRecyclerViewAdapter lRecyclerViewAdapter = (CommonRecyclerViewAdapter) adapter;
                if (lRecyclerViewAdapter.getInnerAdapter() != null && mEmptyView != null) {
                    ...
                    if (count == 0) {
                        ...
                        CommonRecyclerView.this.setVisibility(View.GONE);
                    } else {
                        mEmptyView.setVisibility(View.GONE);
                        CommonRecyclerView.this.setVisibility(View.VISIBLE);
                    }
                }
            } else {
    ...
    public boolean isOnTop() {
        return  mPullRefreshEnabled && mRefreshHeader != null && (mRefreshHeader.getHeaderView().getParent() != null);
    }
