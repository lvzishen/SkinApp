package com.goodmorning.view.tab;
...
public class BottomBarItem extends LinearLayout {
    ...
    private void initAttrs(TypedArray ta) {
        ...
        titleNormalColor = ta.getColor(R.styleable.BottomBarItem_textColorNormal, UIUtils.getColor(context,R.color.color_999999));
        titleSelectedColor = ta.getColor(R.styleable.BottomBarItem_textColorSelected, UIUtils.getColor(context,R.color.color_ff0007));
    ...
    public static final class Builder {
        ...
        public Builder(Context context) {
            ...
            titleNormalColor = getColor(R.color.color_999999);
            titleSelectedColor = getColor(R.color.color_ff0007);
